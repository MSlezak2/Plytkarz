...
//TODO: To make running the app on the localhost possible without configuration data like email password or reCAPTCHA keys
@RestController
    ...
    @PostMapping("/")
        ...
        if (!bindingResult.hasErrors() && reCaptchaResponse.isSuccess()) {
            ...
            try {
                ...
                //TODO: Maybe some feedback dialog on successful / failed email sending?
